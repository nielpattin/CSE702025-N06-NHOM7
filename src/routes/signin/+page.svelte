...
<div class="bg-background min-h-screen">
		...
		<nav class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="flex h-16 items-center justify-between">
				...
				<div class="flex items-center">
					<a href="/" class="border-border bg-secondary hover:bg-muted inline-flex cursor-pointer items-center rounded-md border px-4 py-2 text-sm font-medium text-gray-200 shadow-sm transition-colors hover:border-gray-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 focus:outline-none">
	...
	<main class="mx-auto max-w-md px-4 py-12 sm:px-6 lg:px-8">
		<div class="text-center">
			...
			<!-- Sign In Card -->
			<div class="border-border bg-secondary rounded-lg border p-8 shadow-xl">
				<!-- Header -->
				<div class="mb-6">
				...
				<div class="space-y-3">
					{#each providerMap as provider (provider.id)}
						<SignIn provider={provider.id} signInPage="signin" className="w-full">
							<div slot="submitButton" class="group border-border bg-muted hover:bg-muted relative flex w-full transform cursor-pointer items-center justify-center rounded-lg border px-6 py-4 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:scale-[1.02] hover:border-gray-500 hover:shadow-lg focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-none">
								<!-- Provider Icon -->
